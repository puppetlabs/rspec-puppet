...
module Puppetlabs
  module RSpecPuppet
    module Support
      ...
      @@cache = Puppetlabs::RSpecPuppet::Cache.new
      ...
      def stub_file_consts(example)
        ...
        Puppetlabs::RSpecPuppet::Consts.stub_consts_for(pretend_platform) unless pretend_platform.nil?
      end
      ...
      def load_catalogue(type, exported = false, manifest_opts = {})
        with_vardir do
          ...
          if type == :define
            Puppetlabs::RSpecPuppet::Coverage.add_filter(class_name, title)
          else
            Puppetlabs::RSpecPuppet::Coverage.add_filter(type.to_s, class_name)
          end
          Puppetlabs::RSpecPuppet::Coverage.add_from_catalog(catalogue, test_module)
      ...
      # @return [Puppetlabs::RSpecPuppet::RawString] return a new RawString with the type/title populated correctly
      def ref(type, title)
        Puppetlabs::RSpecPuppet::RawString.new("#{type}['#{title}']")
      end

      # Helper to return value wrapped in Sensitive type.
      #
      # @param [Object] value to wrap
      # @return [Puppetlabs::RSpecPuppet::Sensitive] a new Sensitive wrapper with the new value
      def sensitive(value)
        Puppetlabs::RSpecPuppet::Sensitive.new(value)
      end

      # @!attribute [r] adapter
      #   @api private
      #   @return [Class < Puppetlabs::RSpecPuppet::Adapters::Base]
