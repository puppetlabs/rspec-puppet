...
module Puppetlabs
  class RSpecPuppet::EventListener
    def self.example_started(example)
      @rspec_puppet_example = example.example.example_group.ancestors.include?(Puppetlabs::RSpecPuppet::Support)
...
RSpec.configuration.reporter.register_listener(Puppetlabs::RSpecPuppet::EventListener, :example_started, :example_pending,
                                               :example_passed, :example_failed)

require 'puppetlabs/rspec-puppet/monkey_patches/win32/taskscheduler'
require 'puppetlabs/rspec-puppet/monkey_patches/win32/registry'
require 'puppetlabs/rspec-puppet/monkey_patches/windows/taskschedulerconstants'
    ...
    def find_manifests_in_modules(pattern, environment)
      if Puppetlabs::RSpecPuppet.rspec_puppet_example?
        ...
        unless pretending.nil?
          ...
          Puppetlabs::RSpecPuppet::Consts.stub_consts_for(RSpec.configuration.platform)
        end
        ...
        unless pretending.nil?
          ...
          Puppetlabs::RSpecPuppet::Consts.stub_consts_for pretending
        end
  ...
  module Util
    ...
    if respond_to?(:path_to_uri)
      ...
      def path_to_uri(*args)
        if Puppetlabs::RSpecPuppet.rspec_puppet_example?
          Puppetlabs::RSpecPuppet::Consts.without_stubs do
    ...
    define_method(:hiera_conf_file) do
      if Puppetlabs::RSpecPuppet.rspec_puppet_example?
        if RSpec.configuration.disable_module_hiera
          ...
          config = Puppetlabs::RSpecPuppet.current_example.fixture_spec_hiera_conf(self)
...
module Kernel
  ...
  def require(path)
    return if ['puppet/util/windows',
               'win32/registry'].include?(path) && Puppetlabs::RSpecPuppet.rspec_puppet_example? && Puppet::Util::Platform.pretend_windows?
